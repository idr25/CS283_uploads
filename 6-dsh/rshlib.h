...
#define EXIT_SC                 101         //returned from pipeline excution
                                            //if the command is exit
#define OK_EXIT                 102         //returned when server is exiting
#define STOP_SERVER_SC          200         //returned from pipeline excution
                                            //if the command is to stop the
                                            //server.

//General Error codes
#define OK                       0           //Everything is good
#define ERR_MEMORY              -1          //Memory allocation error
#define ERR_CMD_NOT_FOUND       -2          //Command not found error
